        ...
        <div style={{backgroundColor: "rgb(158, 69, 183)",height:'100vh',color:'white'}}>
            ...
            <div style={{marginTop:'3rem'}}>
                ...
                <div className="col-xl-6 col-12 text-center mt-4 mr-auto ml-auto">
                    <button onClick={() => props.history.push('/donate')} className="btn col-10" style={{color:'white',backgroundColor:'#480d63',fontSize:'1.25rem',paddingRight:50,paddingLeft:50,paddingTop:10,paddingBottom:10}}>I <b style={{fontWeight:'bolder'}}>have</b> supplies</button>
                </div>
            </div>
