    ...
    <GlobalStateContext.Consumer>
      {globalContext => (
        ...
        <Switch>
            ...
            <Route exact={true} path="/dispatch" render={(props) => <DispatchContext.Consumer>{dispatchContext => (<DispatchModuleHome globalContext={globalContext} dispatchContext={dispatchContext} {...props}/>)}</DispatchContext>}/>
        </Switch>
      </BrowserRouter>
      )}
    </GlobalStateContext.Consumer>
